...
class Database
{
    ...
    public function __construct(){
        ...
        /** TODO:: need to ue strategy for change mysql algoritms */
        // self::$instance = new \MysqliDb ($this->getHost(), $this->getUsername(), $this->getPassword(), $this->getName(), $this->getPort());
        self::$instance = new \PDO ("mysql:host={$this->getHost()};dbname={$this->getName()}", $this->getUsername(), $this->getPassword());
